...
<template>
    <div class="mt-5 mx-auto" style="width: 500px">
        ...
        <form @submit.prevent="join">
            ...
            <div class="mb-3">
                <label for="mbti" class="form-label"> <i class="fa-solid fa-lock"></i> mbti: </label>
                <!-- <input type="text" class="form-control" placeholder="mbti" id="mbti" v-model="member.mbti" /> -->
                <select name="mbti" id="mbti" v-model="member.mbti">
